...
function AddPenjualanModal({ isOpen, onClose, onAddPenjualan }) {
  ...
  const handleSubmit = (e) => {
    e.preventDefault();
    axios.post('http://192.168.100.19/api/v1/penjualan/store', formData)
      .then(response => {
        onAddPenjualan(response.data);
        onClose();
...
export default AddPenjualanModal;
